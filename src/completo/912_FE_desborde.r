...
AgregarVariables  <- function( dataset )
{
  ...
  #Aqui debe usted agregar sus propias nuevas variables
    ...
    dataset[ , ctasaldovspay         := mcuentas_saldo / mpayroll ]
	
    dataset[ , reltrnasfer           := mtransferencias_emitidas / mtransferencias_recibidas]
	
    dataset[ , ctasaldovspayage      := mcuentas_saldo / mpayroll_sobre_edad ]

    dataset[ , rentavsctasaldo       := mrentabilidad_annual / mcuentas_saldo ]	
	
     dataset[ , rentavsctasaldo       := mrentabilidad_annual / ctasaldovspay ]	 
...
if( PARAM$tendenciaYmuchomastres$correr ) 
{
  p  <- PARAM$tendenciaYmuchomastres
